...
class DataStore implements DataStoreInterface
{
    ...
    {
        if (defined('VSTACK_API_KEY') && defined('VSTACK_EMAIL')) {
            return true;
        }
    ...
    {
        if (defined('VSTACK_API_KEY') && VSTACK_API_KEY !== '') {
            return VSTACK_API_KEY;
        }
    ...
    {
        if (defined('VSTACK_DOMAIN_NAME') && VSTACK_DOMAIN_NAME !== '') {
            return idn_to_utf8(VSTACK_DOMAIN_NAME, IDNA_DEFAULT, INTL_IDNA_VARIANT_UTS46);
        }
    ...
    {
        if (defined('VSTACK_EMAIL') && VSTACK_EMAIL !== '') {
            return VSTACK_EMAIL;
        }
    ...
    {
        $pluginKeys = \VSTACK\API\Plugin::getPluginSettingsKeys();
