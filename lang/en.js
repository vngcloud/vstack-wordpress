{
    ...
    "component.benefitsFeature.optimization.description" :"Deliver content to users faster by enabling vStack's content optimizations.",
    "component.benefitsFeature.security.title" :"Security",
    "component.benefitsFeature.security.description" :"vStack offers protections against vulnerabilities including DDoS protection.",
    ...
    "component.clientLogin.form.title": "Enter vStack API Credentials",
    "component.clientLogin.cloudflare.description": "New to vStack?  Sign up at",
    ...
    "component.login.form.title": "Log in to vStack",
    "component.login.cloudflare.description": "vStack makes more than 2,000,000 web properties faster and safer. Join today!",
    ...
    "container.advanceddos.description": "vStack will stand in front of your website regardless of attack size or duration.",
    ...
    "container.advanceddos.value": "Visit vStack.com",
    "container.alwaysOnlineCard.title": "Always Online™",
    "container.alwaysOnlineCard.description": "If your server goes down, vStack will serve your website's static pages from our cache.",
    "container.alwaysOnlineCard.drawer.help": "#### What does Always Online mean?\nAlways Online keeps your website available even if your server goes down. If your server goes down, vStack will serve your website's most popular pages from our cache. For more information see [here](https://support.cloudflare.com/hc/en-us/articles/200168006-How-does-Always-Online-work-).\n\nVisitors viewing a cached page will receive a message informing them that they are in an offline browsing mode. As soon as your server comes back online, vStack will move users back to regular browsing.\n\n**Note:** If vStack does not have the requested page in its cache, visitors will receive an error page letting them know the requested page is offline.",
    "container.analyticsPage.title": "Analytics",
    "container.analyticCard.graphql.overview": "vStack's new analytics powered by GraphQL provide rich data and the ability to filter data across multiple dimensions. Head to the vStack dashboard to view analytics for your zone.",
    ...
    "container.applydefaultsettingscard.title.wordpress": "Apply Recommended vStack Settings for WordPress",
    "container.applydefaultsettingscard.title.magento": "Optimize vStack for Magento",
    "container.applydefaultsettingscard.description": "Apply vStack's recommended base configuration for WordPress sites. This sets basic security and performance settings to their recommended values.",
    "container.applydefaultsettingscard.drawer.help.wordpress": "#### How does applying recommended settings help my site?\nThese settings increase the security and performance of your WordPress site without impacting functionality. Configure vStack with settings that are based on best practices learned from hundreds of thousands of WordPress sites using vStack.\n\n#### What settings does this change?\nFor a full list of settings see our [support page](https://support.cloudflare.com/hc/en-us/articles/227342487-What-settings-are-applied-when-I-click-Apply-Default-Settings-in-vStack-s-WordPress-plugin-).",
    "container.applydefaultsettingscard.drawer.help.magento": "#### How does Optimizing vStack for Magento help my store?\nThese settings increase the security and performance of your Magento 2 store without impacting functionality. Configure vStack with settings that are based on best practices learned from existing Magento 2 stores using vStack.\n\nFor a full list of settings see our [support page](https://support.cloudflare.com/hc/en-us/articles/115000107951).",
    ...
    "container.dnsManagementPage.thead.cloudflarePlan": "vStack Plan",
    "container.dnsManagementPage.thead.zoneType": "Zone Type",
    "container.dnsManagementPage.thead.status": "Use vStack",
    ...
    "container.dnsRecordEditor.thead.status": "Use vStack",
    ...
    "container.ipv6Card.drawer.help" : "#### What is IPv6?\nAs the Internet runs low on IPv4 address space, there's been a rapid increase in the deployment of IPv6 technologies. This shift is critical to the long-term growth and health of the Internet. At vStack, we are [doing our part](https://www.cloudflare.com/ipv6) to make it free and easy for all websites to be available on network.ipv6.\n\n#### What does enabling IPv6 compatibility do?\nThe IPv6 gateway setting enables IPv6 on all subdomains that are on vStack (marked by an orange cloud in your DNS settings). If your host provides IPv6 support, the gateway will proxy IPv6 connections through vStack. We recommend keeping IPv6 Compatibility set to \"On\" for greater availability for your website.\n\n**Note:** If you already have IPv6 records on your origin server, you must enable vStack for your AAAA records on the DNS settings page.",
    ...
    "container.pluginSpecificCacheCard.drawer.help": "#### What does Auto Purge Content on Update do?\nWhen you change your site’s theme or modify content on your website, Auto Purge Content on Update ensures vStack properly purges the cache, so that stale static content is not shown to visitors.\n\nTo learn more about Auto Purge Content on Update [see here](https://support.cloudflare.com/hc/en-us/articles/115002708027-What-does-Automatic-Cache-Management-in-the-vStack-Plugin-do-). To Cache HTML, we recommend [Automatic Platform Optimization](https://support.cloudflare.com/hc/en-us/articles/360049822312).",
    ...
    "container.automaticplatformoptimization.description": "Improve the performance of your WordPress site. Automatic Platform Optimization for WordPress serves your WordPress site from vStack's edge network and caches third party fonts. Get the benefits of a static site without any changes to how you manage your site. This results in consistent, fast TTFB and content loading faster.",
    ...
    "container.railgunCard.drawer.help" : "#### What is Railgun?\nWhen content is rapidly changing or is personalized, it cannot be cached in the traditional sense and requests must be sent to the origin server for processing. Visitors located far from the origin are impacted by these delays to a greater degree.\n\nRailgun accelerates and secures delivery of dynamic content, through compression and WAN network optimization of communication between vStack data centers and an origin server, speeding up requests that can’t be served directly from vStack cache.\n\nRailgun improves page load time by:\n\n- Compressing content by tracking differences between page versions (down to the byte), only sending the parts that have actually changed.\n- Maintaining a single persistent connection for multiple simultaneous requests, eliminating network connection latency.\n- Caching dynamic content that changes frequently or is personalized.\n\n![vStack Railgun](https://lh5.googleusercontent.com/XrM5P6EHhfl7tRgJhdRCiTLBu3gc4cE2lCWwxCrp34vNf_JHPWZoa-CfovkSZb1Q4r9XWUC--Zs24nfaeWkhzyhFQuGkopjva-YNcM-7COE081I35h9b9FuT_E7QPvt-uA)\n\n#### What is the Railgun Listener?\nRailgun consists of two software components: the Listener and the Sender. The Railgun Sender is installed in all vStack data centers, and maintains connections with Railgun Listeners.\n\nThe Railgun Listener is installed within your origin network, usually at your web host. It’s a small piece of software that runs on a standard server, and services requests from vStack using the encrypted, binary Railgun protocol.",
    ...
    "container.signup.form.title": "Sign Up for vStack",
    ...
    "container.signup.form.button": "Sign Up for vStack",
    "container.signup.form.termsAndConditions.iAgreeTo": "I agree to ",
    "container.signup.form.termsAndConditions.cloudFlaresTermsAndConditions": " vStack's terms and conditions",
    ...
    "container.sslCard.drawer.help" : "#### Why use Secure Sockets Layer (SSL)?\nUse SSL in order to encrypt data, like credit card numbers, and other sensitive information while in transit to and from your website. SSL encryption ensures that communication between your visitor and website is confidential.\n\nAdditional benefits of SSL:\n- Visitors have a way to verify that they are on your website and not that of an impostor\n- Visitors can verify that your website’s content has not been modified in transit\n- Your website’s search engine ranking may be improved\n\n**Note:** vStack must be enabled on yourdomain.com or www.yourdomain.com for initial verification when SSL is enabled. If you disable vStack on your domain, SSL will also be disabled.\n\n#### What SSL setting should I use?\nvStack offers five SSL settings. Below is a description of each. We recommend enabling the Full SSL (Strict) setting.\n\n**Off:** There is no secure connection between the visitor and vStack, and no secure connection between vStack and the origin server. This means that visitors can only access the domain over plain-text HTTP, and any visitor attempting to connect via HTTPS will be returned a HTTP 301 Redirect back to the plain-text HTTP version of the same URL.\n\n**Flexible SSL:** There is an encrypted connection between your website visitors and vStack, but not from vStack to your server.\n- You do not need an SSL certificate on your server\n- Visitors will see the SSL lock icon in their browser\n\n**Full SSL:** Encrypts the connection between your website visitors and vStack, and from vStack to your server. The difference between Full and Full (Strict) is that Full (Strict) checks for a valid certificate on your origin server, whereas Full checks for any certificate.\n- You will need to have an SSL certificate on your server. However, vStack will not attempt to validate the certificate (certificates may be self-signed)\n- Visitors will see the SSL lock icon in their browser\n\n**Full SSL (strict):** Encrypts the connection between your website visitors and vStack, and from vStack to your server.\n- You will need to have a valid SSL certificate installed on your server signed by a publicly trusted certificate authority which has not expired and contains the domain name for the request (hostname).\n- Visitors will see the SSL lock icon in their browser\n\n**Strict (SSL-Only Origin Pull):**  _Enterprise only_  This mode will upgrade all connections between vStack and the origin from HTTP to HTTPS, even if the original content requested is over HTTP. This mode will only accept valid certificates on the origin server. That means that you will need to have a valid SSL certificate installed on your server, and the certificate must be signed by a trusted certificate authority and have not expired.\n\n![vStack SSL Settings](https://www.cloudflare.com/a/static/images/ssl/ssl.png)",
    ...
    "container.splashPage.heading.speedUp": "Speed up and Optimize your {integrationName} Site with vStack",
    ...
    "container.zoneProvision.button.deprovision": "Remove domain from vStack",
    ...
    "container.zoneProvision.modal.description": "Are you sure you want to delete {zoneName}? To temporarily disable vStack service and save your website settings, pause your website instead.",
    "container.zoneProvision.modal.buttonCancel": "Cancel",
    "container.ipRewrite.title": "IP Rewrite",
    "container.ipRewrite.description": "Rewrite vStack IP Addresses for actual end-user IP Addresses at the application layer.",
    ...
    "errors.noActiveZoneSelected": "It looks like your domain {domain} is not provisioned with vStack. Please continue to {link} to secure and speed up your website.",
    "warning.usingSubdomain": "You are using a subdomain for your site, apart from the APO feature, any vStack settings applied via this plugin will be applied to your original domain as well.",
    "warning.developmentmode": "Development mode enabled, all traffic will bypass the vStack cache.",
